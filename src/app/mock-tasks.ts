...
export const TASKS: TaskObj[] = [
  { id: 1, name: "Programa tasks", owner: 0, description: "Crear la versión 0.1", created:new Date(), filter:true, selected:false, status: 1, creator: 0,dueDate : new Date('2021-04-21'), resolvedT : null, closedT: null},
